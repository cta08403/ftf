package com.mebius.format.ftf
{
	...
	internal class FTFHeader
	{
		private var _vo:FTFHeaderVo;
		
		public function FTFHeader()
		{
			this._vo = new FTFHeaderVo();
		}
		...
		public function readHeaderData( val:ByteArray ):void
		{
			...
			{
				FTFEventTrigger.disEvent( FTFErrorEvent.FILE_TYPE_ERROR,"the file is not ftf format file.");
			}
			else
			{
				...
				{
					FTFEventTrigger.disEvent( FTFErrorEvent.VERSION_UNRECOGNIZED_ERROR,"ftf file version is error.");
				}
				else
				{
